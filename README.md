...
Read the accompanying article: [`docs/implement-transactional-outbox-aws.md`](./docs/implement-transactional-outbox-aws.md)
Read the architecture decision record (ADR): [`docs/adr.md`](./docs/adr.md)
